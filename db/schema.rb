...
ActiveRecord::Schema[7.0].define(version: 2023_01_16_141437) do
  ...
  create_table "carts_products", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["cart_id", "product_id", "bonus"], name: "index_carts_products_on_cart_id_and_product_id_and_bonus"
  end
  ...
  create_table "products_actions", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["product_id", "action_id"], name: "index_products_actions_on_product_id_and_action_id", unique: true
  end
